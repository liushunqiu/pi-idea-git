...
function page({ title, surface, locale }) {
  return `<!-- GENERATED by tools/build.mjs — do not edit; edit src/* -->
<!doctype html>
<html lang="${locale}">
  <head>
    <meta charset="UTF-8" />
    ...
    <!--
      PI-Desktop owns exactly a transparent 46px drag band and a minimal three-button
