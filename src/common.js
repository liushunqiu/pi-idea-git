...
(function (PIG) {
  ...
  const STRINGS = {
    en: {
      ...
      goToHead: "Go to HEAD",
      mineOnly: "Mine only",
      recentUsers: "Recent committers",
      filterUserPlaceholder: "Name or email, Enter to filter…",
      anyTime: "Any time",
      ...
      stashes: "Stashes",
      remotes: "Remotes",
      mergeTitle: "Merge into the current branch?",
      rebaseTitle: "Rebase the current branch?",
      deleteBranchTitle: "Delete this branch?",
      renameTitle: "Rename branch",
      setUpstreamTitle: "Set upstream",
      deleteTagTitle: "Delete this tag?",
      mergeConflicts: "The merge stopped on conflicts — resolve them in the Changes list, then commit to finish.",
      rebaseConflicts: "The rebase stopped on conflicts — resolve them in the Changes list, then continue.",
      stash: "Stash",
      ...
      replace: "Replace",
      draftedStaged: "Commit message drafted from checked (staged) changes",
      ...
      showDetail: "Show details",
       ...
       generateScope: "{{action}} · {{lang}} (uses checked/staged changes)",
    ...
    "zh-CN": {
      ...
      mineOnly: "只看我的",
      recentUsers: "最近提交者",
      filterUserPlaceholder: "输入姓名或邮箱，回车过滤…",
      anyTime: "全部时间",
      lastDay: "最近 24 小时",
      lastWeek: "最近一周",
      lastMonth: "最近一月",
      ...
      remotes: "远端",
      mergeTitle: "合并到当前分支？",
      rebaseTitle: "把当前分支变基到所选分支？",
      deleteBranchTitle: "删除该分支？",
      renameTitle: "重命名分支",
      setUpstreamTitle: "设置上游分支",
      deleteTagTitle: "删除该标签？",
      mergeConflicts: "合并因冲突停下 — 请在变更列表里解决冲突，然后提交完成。",
      rebaseConflicts: "变基因冲突停下 — 请在变更列表里解决冲突，然后点「继续」。",
      stash: "储藏",
      stashChanges: "储藏更改",
      unstash: "取消储藏",
      dropStash: "删除储藏",
      ...
      replace: "替换",
      draftedStaged: "已生成提交信息（来源：已勾选/已暂存内容）",
      ...
      showDetail: "查看详情",
       ...
       generateScope: "{{action}} · {{lang}}（基于已勾选/已暂存内容）",
